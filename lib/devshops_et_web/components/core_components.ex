defmodule DevshopsEtWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      role="alert"
      class={[
        "fixed top-2 right-2 mr-2 w-80 sm:w-96 z-50 p-3 ring-1 box-shadow border border-black",
  ...
  def input(%{type: "textarea"} = assigns) do
    ...
    <div>
      ...
      <textarea
        ...
        name={@name}
        class={[
          "mt-2 block w-full sm:text-lg sm:leading-6 min-h-[6rem] bg-transparent box-shadow",
          @errors == [] && "border-black",
  ...
  def icon(%{name: "facebook"} = assigns) do
    ~H"""
  ...
  def icon(%{name: "instagram"} = assigns) do
    ~H"""
    <svg class={@class} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  def icon(%{name: "telegram"} = assigns) do
    ~H"""
    <svg class={@class} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  def icon(%{name: "whatsapp"} = assigns) do
    ~H"""
    <svg class={@class} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DevshopsEtWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DevshopsEtWeb.Gettext, "errors", msg, opts)
    end
  end
